...
public class ImageControllerTests {
    ...
    @Test
    public void saveImages_MissingFile_isBadRequest() throws Exception {
        mockMvc.perform(multipart("/api/products/{productId}/images", existingId)
                            .contentType(MediaType.MULTIPART_FORM_DATA))
    ...
    @Test
    public void saveImages_WrongFieldName_isBadRequest() throws Exception {
    ...
    @Test
    public void saveImages_InvalidId_isBadRequest() throws Exception {
        MockMultipartFile file = getValidMultipartFile();
    ...
    @Test
    public void saveImages_NonExistingId_isNotFound() throws Exception {
        MockMultipartFile file = getValidMultipartFile();
    ...
    @Test
    public void saveImages_WrongContentType_isUnsupportedMediaType() throws Exception {
        mockMvc.perform(multipart("/api/products/{productId}/images", existingId)
    ...
    @Test
    public void saveImages_FileTooLarge() throws Exception {
        MockMultipartFile file = getValidMultipartFile();
    ...
    @Test
    public void downloadImage_InvalidId_isBadRequest() throws Exception {
    ...
    @Test
    public void downloadImage_NonExistingId_isNotFound() throws Exception {
    ...
    @Test
    public void updateImage_MissingFile_isBadRequest() throws Exception {
        mockMvc.perform(multipart(HttpMethod.PUT, "/api/images/{id}", existingId)
                            .contentType(MediaType.MULTIPART_FORM_DATA))
               .andExpect(status().isBadRequest());
    ...
    @Test
    public void updateImage_InvalidId_isBadRequest() throws Exception {
        MockMultipartFile file = getValidMultipartFile();
    ...
    @Test
    public void updateImage_WrongContentType_isUnsupportedMediaType() throws Exception {
    ...
    @Test
    public void updateImage_NonExistingId_isNotFound() throws Exception {
        MockMultipartFile file = getValidMultipartFile();
